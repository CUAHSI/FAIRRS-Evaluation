...
def get_cff_citation(metadata):
    """
    
    Returns CFF citation file from metadata input for updating metadata in the GitHub repository.
    ...
    endpoint_url = 'https://observatory.openebench.bsc.es/api/tools/cff'
